...
public:
	...
	{
		// Load object file
		meshCube.LoadFromObjectFile("/home/aly/Work/C++ Scripts/SummerProjects2024/3DEngineReborn/src/objectFiles/Primitives/axis.obj");
    ...
    /*cout << "POINT AT MATRIX:\n";
    for(int i = 0; i < 4; i++)
    {
      for(int j = 0; j < 4; j++)
      {
        cout << matCamera.m[i][j] << ' ';
      }
      cout << "\n";
    }*/
    ...
    for(int i = 0; i < 4; i++)
    {
      ...
      cout << '\n';
        ...
        float dpCol = normal.x * light_direction.x + normal.y * light_direction.y + normal.z * light_direction.z;
        olc::Pixel colorCode = {uint8_t(255 * dpCol), uint8_t(255 * dpCol), uint8_t(255 * dpCol)};
				triTransformed.color = colorCode;
		...
		for (auto &triToRaster : vecTrianglesToRaster)
		{
					...
					for (int w = 0; w < nTrisToAdd; w++)
          {
			...
			{
        olc::vf2d point1 = {t.p[0].x, t.p[0].y};
        olc::vf2d point2 = {t.p[1].x, t.p[1].y};
        olc::vf2d point3 = {t.p[2].x, t.p[2].y};
